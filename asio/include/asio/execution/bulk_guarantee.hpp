...
struct bulk_guarantee_t
{
  ...
  typename traits::query_static_constexpr_member<T, bulk_guarantee_t>::result_type
  static_query()
    ASIO_NOEXCEPT_IF((
  ...
  template <typename E, typename T = decltype(bulk_guarantee_t::static_query<E>())>
  ...
  friend ASIO_CONSTEXPR bulk_guarantee_t query(
    ...
    ASIO_NOEXCEPT_IF((
      is_nothrow_query<const Executor&, bulk_guarantee_t<>::unsequenced_t>::value))
...
#if defined(_MSC_VER) // Visual C++ wants the type to be qualified.
    ASIO_NOEXCEPT_IF((
      is_nothrow_query<const Executor&, bulk_guarantee_t<>::sequenced_t>::value))
#elif !defined(__clang__) // Clang crashes if noexcept is used here.
    ASIO_NOEXCEPT_IF((
...
template <int I>
const typename bulk_guarantee_t<I>::unsequenced_t bulk_guarantee_t<I>::unsequenced;
...
struct static_query<T, execution::bulk_guarantee_t,
  typename enable_if<
    !traits::query_static_constexpr_member<T, execution::bulk_guarantee_t>::is_valid
      && !traits::query_member<T, execution::bulk_guarantee_t>::is_valid
      && traits::static_query<T, execution::bulk_guarantee_t::unsequenced_t>::is_valid
  >::type>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  static ASIO_CONSTEXPR result_type value()
  {
    return traits::static_query<T, execution::bulk_guarantee_t::unsequenced_t>::value();
  }
};
...
struct static_query<T, execution::bulk_guarantee_t,
  typename enable_if<
    !traits::query_static_constexpr_member<T, execution::bulk_guarantee_t>::is_valid
      && !traits::query_member<T, execution::bulk_guarantee_t>::is_valid
      && !traits::static_query<T, execution::bulk_guarantee_t::unsequenced_t>::is_valid
      && traits::static_query<T, execution::bulk_guarantee_t::sequenced_t>::is_valid
  >::type>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  static ASIO_CONSTEXPR result_type value()
  {
    return traits::static_query<T, execution::bulk_guarantee_t::sequenced_t>::value();
  }
};
...
struct static_query<T, execution::bulk_guarantee_t,
  typename enable_if<
    !traits::query_static_constexpr_member<T, execution::bulk_guarantee_t>::is_valid
      ...
      && !traits::static_query<T, execution::bulk_guarantee_t::unsequenced_t>::is_valid
      && !traits::static_query<T, execution::bulk_guarantee_t::sequenced_t>::is_valid
      && traits::static_query<T, execution::bulk_guarantee_t::parallel_t>::is_valid
  >::type>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  static ASIO_CONSTEXPR result_type value()
  {
    return traits::static_query<T, execution::bulk_guarantee_t::parallel_t>::value();
  }
};
...
struct static_query<T, execution::bulk_guarantee_t::unsequenced_t,
  typename enable_if<
    !traits::query_static_constexpr_member<T,
      execution::bulk_guarantee_t::unsequenced_t>::is_valid
      && !traits::query_member<T, execution::bulk_guarantee_t::unsequenced_t>::is_valid
      && !traits::query_free<T, execution::bulk_guarantee_t::unsequenced_t>::is_valid
      && !can_query<T, execution::bulk_guarantee_t::sequenced_t>::value
      && !can_query<T, execution::bulk_guarantee_t::parallel_t>::value
  >::type>
{
